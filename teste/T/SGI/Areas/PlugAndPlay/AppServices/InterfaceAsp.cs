...
namespace SGI.Areas.PlugAndPlay.AppServices
{
    public class InterfaceAsp
    {
        private Timer _timer;
        private static readonly InterfaceAsp _instance = new InterfaceAsp();
        private InterfaceAsp() { }
        public static InterfaceAsp Instancia
        {
            get
            {
                return _instance;
        ...
        public void Iniciar()
        {
            _timer = new Timer(GravarMedicao, null, 5000, Timeout.Infinite);
        }
